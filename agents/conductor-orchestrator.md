...
If user provided a goal via `/gilfoyle`, skip to the Goal-Driven Entry section below.
...
## GOAL-DRIVEN ENTRY (/gilfoyle)

When invoked with `/gilfoyle <goal>`, follow this flow:
