...
> **DEPRECATED**: This command has been renamed to `/conductor:review`. Please use `/conductor:review` instead. This alias will be removed in a future version.
...
3. Re-run `/phase-review` (loop back to Step 4)
4. Repeat until PASS
...
- `/conductor:run` — Execute track tasks
