---
name: review
description: "Run post-execution quality gate (renamed from phase-review)"
arguments:
  - name: track_id
...
# /conductor:review — Post-Execution Quality Gate
...
> This command replaces the deprecated `/phase-review` command with the same functionality under the conductor namespace.
...
3. Re-run `/conductor:review` (loop back to Step 4)
4. Repeat until PASS

## Related

- `/conductor:run` — Automated loop that includes this review step
- `/conductor:tech-review` — CTO-level architecture review (complementary)
