...
user_invocable: true
deprecated: true
deprecated_in_favor_of: "/conductor:tech-review"
---

# /cto-advisor

> **DEPRECATED**: This command has been renamed to `/conductor:tech-review`. Please use `/conductor:tech-review` instead. This alias will be removed in a future version.
...
- `/conductor:run` — Automated loop that includes CTO review
